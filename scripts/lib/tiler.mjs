...
export const LAYER_DEFS = [
  { id: "boundary-city",    minzoom: 0, maxzoom: 9,  tolerance: 0.0002, name: "地市边界", type: "boundary", group: "行政区划" },
  { id: "boundary-county",  minzoom: 0, maxzoom: 11, tolerance: 0.0002, name: "区县边界", type: "boundary", group: "行政区划" },
  { id: "highways",         minzoom: 5, maxzoom: 13, tolerance: 0.0001, name: "高速公路", type: "road", group: "公路网" },
  { id: "roads-trunk",      minzoom: 5, maxzoom: 13, tolerance: 0.0001, name: "国省道", type: "road", group: "公路网" },
  { id: "roads-rural",      minzoom: 7, maxzoom: 14, tolerance: 0.0001, name: "农村公路", type: "road", group: "公路网" },
...
/** 按类型推断分组（导入图层时使用） */
export const GROUP_BY_TYPE = { boundary: "行政区划", road: "公路网", point: "设施点" };
